			...
			<div class="post-inner-content">
				...
				<section class="error-404 not-found">
					<header class="page-header">
						<h1 class="page-title"><?php esc_html_e( 'Error 404. Page not Found', 'activello' ); ?></h1>
					</header><!-- .page-header -->
					...
					<div class="page-content">
						...
						<p>
						<br>
						<?php esc_html_e( 'Maybe you can find what you are looking for, from the menu below.', 'activello' ); ?></p>
